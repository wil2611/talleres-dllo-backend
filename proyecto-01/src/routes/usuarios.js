...
router.post('/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ id: usuario.correo }, JWT_SECRET);
    res.send({ usuario, token });
}));
router.put('/:correo/roles', authenticate_1.authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { roles } = req.body;
    const { correo } = req.params;
    yield (0, Usuario_1.updateUsuarioRoles)(correo, roles);
    res.send({ success: 'Roles actualizados' });
}));
router.delete('/:correo', authenticate_1.authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { correo } = req.params;
